...
var (
	MainnetGenesisHash = common.HexToHash("0xbfe8fb58cdb8f47f137b4bea0dad9ca2f996cafa908782a77db896b034cefa80")
...
var (
	...
	AllBposProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, &BposConfig{Period: 0, Epoch: 30000}}
