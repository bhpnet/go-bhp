...
var (
	MainnetGenesisHash = common.HexToHash("0x5f960cc574aa0eada0124de764e57a4cdf5ae56bbab674b968b912bce9aba8b2")
	TestnetGenesisHash = common.HexToHash("0x5f960cc574aa0eada0124de764e57a4cdf5ae56bbab674b968b912bce9aba8b2")
)
...
var (
	...
	AllBposProtocolChanges = &ChainConfig{big.NewInt(999), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, &BposConfig{Period: 0, Epoch: 30000}}
