...
const (
	clientIdentifier = "gbhp" // Client identifier to advertise over the network
)
...
func init() {
	...
	app.Copyright = "Copyright 2013-2020 The go-bhp Authors"
...
func prepare(ctx *cli.Context) {
	...
	case ctx.GlobalIsSet(utils.TestnetFlag.Name):
		log.Info("Starting Gbhp on testnet...")
	case ctx.GlobalIsSet(utils.DeveloperFlag.Name):
		log.Info("Starting Gbhp in ephemeral dev mode...")

	case !ctx.GlobalIsSet(utils.NetworkIdFlag.Name):
		log.Info("Starting Gbhp on BHP mainnet...")
	}
